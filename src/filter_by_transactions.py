...
def get_filter_by_string(file_path: str, search_string: str) -> List[Dict[str, Any]]:
    """Функция которая принимает на вход список словарей из json файла и строку поиска, а на выход отдает
    список словарей у которых в описании есть данныя строка"""
...
def get_filter_by_category(file_path: str, categories: list[str]) -> Dict[str, Any]:
    """Функция которая принимает список словарей из json файла и список категорий, а возвращает словарь
